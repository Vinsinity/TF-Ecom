                    ...
                    <form action="{{ route('admin.auth.login.post') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input name="email" type="email" class="form-control input-lg @error('email') error @enderror" id="email" aria-describedby="emailHelp" placeholder="Username">
                            </div>

                            <div class="form-group col-md-12 ">
                                <input name="password" type="password" class="form-control input-lg @error('password') error @enderror" id="password" placeholder="Password">
                            </div>
