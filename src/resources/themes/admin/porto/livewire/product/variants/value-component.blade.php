    ...
    <div class="datatable-header">
        <div class="row align-items-center mb-3">
            ...
            <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                <a href="{{ route('admin.variants.add.value', ['slug' => $option]) }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Value to {{ $option->name }}</a>
            </div>
    ...
    <table class="table table-responsive-lg  table-striped table-sm mb-0">
        ...
        @foreach($option->values as $value)
            <tr>
                ...
                <td class="align-middle"><strong>{{ $value->id }}</strong></td>
                <td class="align-middle">
                    <strong>{{ $value->value }}</strong>
                </td>
                <td class="align-middle">
                    <a href="" type="button" class="mb-1 mt-1 me-1 btn btn-primary"><i class="bx bx-pencil"></i></a>
                    <a class="mb-1 mt-1 me-1 modal-basic btn btn-default btn-danger" wire:click="deleteId({{ $value->id }})" href="#modalDelete"><i class="bx bx-trash"></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
