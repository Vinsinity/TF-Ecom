...
<header class="header header-nav-menu header-nav-links">
    <div class="logo-container">
        <a href=".." class="logo">
            <img src="{{ asset('themes/admin/porto/assets') }}/img/logo-modern.png" class="logo-image" width="150" alt="BESoft Admin" />
            <img src="{{ asset('themes/admin/porto/assets') }}/img/logo-default.png" class="logo-image-mobile" width="90" height="41" alt="Porto Admin" />
        </a>
    ...
    <div class="header-right">
        ...
        <a class="dropdown-language nav-link" href="#" role="button" id="dropdownLanguage" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img src="{{ asset('themes/admin/porto/assets/img/blank.gif') }}" class="flag flag-{{config('app.locale')}}" alt="English" /> {{ strtoupper(config('app.locale')) }}
            <i class="fas fa-chevron-down"></i>
        </a>
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
            @foreach(config('app.languages') as $key => $languages)
                <a class="dropdown-item" href="{{ route('admin.language.set', ['lang' => $key]) }}">
                    <img src="{{ asset('themes/admin/porto/assets/img/blank.gif') }}" class="flag flag-{{$key}}" alt="{{ $languages }}" />
                    {{ $languages }}
                </a>
            @endforeach
        </div>
        ...
        <div id="userbox" class="userbox">
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled mt-3">
                    ...
                    <li>
                        <form id="logout" action="{{ route('admin.auth.logout') }}" method="POST">
                            @csrf
                            <a href="javascript:{}" onclick="document.getElementById('logout').submit();" role="menuitem" tabindex="-1"><i class="bx bx-log-out"></i> Logout</a>
                        </form>
                    </li>
                </ul>
            </div>
