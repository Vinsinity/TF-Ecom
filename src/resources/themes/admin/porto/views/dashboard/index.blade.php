@extends('app', ['title' => trans('dashboard.static.dashboard')])
@push('stylesheet')
    <link rel="stylesheet" href="{{ asset('themes/admin/porto/assets/vendor/morris/morris.css') }}" />
    <link rel="stylesheet" href="{{ asset('themes/admin/porto/assets/vendor/datatables/media/css/dataTables.bootstrap5.css') }}" />
@endpush
@section('content')
    <!-- start: page -->
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-ecommerce-simple table-borderless table-striped mb-1">
                            ...
                            <tbody>
                            <tr>
                                <td width="72"><a href="#"><img src="{{ asset('themes/admin/porto/assets') }}/img/products/product-1.jpg" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
                                <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                                <td width="90">$15</td>
                            </tr>
                            <tr>
                                <td><a href="#"><img src="{{ asset('themes/admin/porto/assets') }}/img/products/product-2.jpg" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
                                <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                                <td>$15</td>
                            </tr>
                            <tr>
                                <td><a href="#"><img src="{{ asset('themes/admin/porto/assets') }}/img/products/product-3.jpg" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
                                <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                                <td>$15</td>
                            </tr>
                            <tr>
                                <td><a href="#"><img src="{{ asset('themes/admin/porto/assets') }}/img/products/product-4.jpg" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
                                <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                                <td>$15</td>
                            </tr>
                            <tr>
                                <td><a href="#"><img src="{{ asset('themes/admin/porto/assets') }}/img/products/product-5.jpg" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
                                <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                                <td>$15</td>
                            </tr>
                            </tbody>
...
@endsection
@push('specificJs')
    <script src="{{ asset('themes/admin/porto/assets/vendor/raphael/raphael.js') }}"></script>
    <script src="{{ asset('themes/admin/porto/assets/vendor/morris/morris.js') }}"></script>
    <script src="{{ asset('themes/admin/porto/assets/vendor/datatables/media/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('themes/admin/porto/assets/vendor/datatables/media/js/dataTables.bootstrap5.min.js') }}"></script>
@endpush
@push('examplesJs')
    <script src="{{ asset('themes/admin/porto/assets/js/examples/examples.header.menu.js') }}"></script>
    <script src="{{ asset('themes/admin/porto/assets/js/examples/examples.ecommerce.dashboard.js') }}"></script>
    <script src="{{ asset('themes/admin/porto/assets/js/examples/examples.ecommerce.datatables.list.js') }}"></script>
@endpush
