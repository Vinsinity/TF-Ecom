...
{{--    // ecommerce-form for jquery upload--}}
    ...
    @endif
    <form class="action-buttons-fixed" action="{{ route('admin.variants.add.value.post', ['slug' => $option->slug]) }}" method="post">
        @csrf
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">{{ $option->name }} Value</h2>
                                <p class="card-big-info-desc">Add here the category description with all details and necessary information.</p>
                            </div>
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center mb-3">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Variant Name</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" value="{{ $option->name }}" required disabled />
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Option</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" name="value" placeholder="Option name for variant" required />
                                    </div>
                                </div>
{{--                                <div class="form-group row align-items-center mb-3">--}}
{{--                                    <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Value</label>--}}
{{--                                    <div class="col-lg-7 col-xl-6">--}}
{{--                                        <input type="text" class="form-control form-control-modern" name="value" placeholder="Value for option" required />--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                            </div>
                        </div>
        ...
        <div class="row action-buttons">
            <div class="col-12 col-md-auto">
                <button type="submit" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
                    <i class="bx bx-save text-4 me-2"></i> Save Value
                </button>
            </div>
