@extends('app', ['title' => $category->name.' Edit'])
@push('stylesheet')
...
{{--    {{ route('admin.product.categories.update', ['slug' => $category->slug]) }}--}}
    <form class="action-buttons-fixed" action="{{ route('admin.categories.update',['slug' => $category->slug]) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center mb-3">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-end">Category Name</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" name="name" value="{{ $category->name }}" required />
{{--                                        <input type="text" class="form-control form-control-modern" hidden name="category_id" value="{{ $category->name }}" />--}}
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-end">Image</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="file" class="form-control" name="image">
                                        @if($category->image)
                                            <img class="rounded mt-2" src="{{ Storage::url($category->image) }}" width="100%" alt="">
                                        @endif
{{--                                        <input type="text" class="form-control form-control-modern" name="name" value="{{ $category->name }}" required />--}}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row align-items-center mb-3">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-end" for="order">Order</label>
                                    <div class="col-lg-7 col-xl-6">
