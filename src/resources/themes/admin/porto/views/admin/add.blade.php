...
{{--    // ecommerce-form for jquery upload--}}
    <form class="brand-form action-buttons-fixed" action="{{ route('admin.admins.add.post') }}" method="post">
        @csrf
        <div class="row mt-2">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">Admin Details</h2>
                                <p class="card-big-info-desc">Add here the admin description with all details and necessary information.</p>
                            </div>
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center mb-3">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Admin Name</label>
                                ...
                                <div class="form-group row align-items-center mb-3">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" name="password" value="" required />
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    <label for="role" class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Role</label>
                                    <div class="col-lg-7 col-xl-6">
