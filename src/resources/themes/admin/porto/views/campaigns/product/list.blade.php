@extends('app', ['title' => 'Product Discount List'])
@section('content')
    <!-- start: page -->
                        ...
                        <div class="datatable-header">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                    <a href="{{ route('admin.permissions.add') }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Product Discount</a>
                                </div>
                            ...
                            <tbody>
                                    @foreach($discounts as $discount)
                                        <tr>
                                            ...
                                            <td>
                                                <strong>
                                                    <a href="{{ route('admin.products.show', ['slug' => $discount->product]) }}">{{ $discount->product->name }}</a>
                                                </strong>
                                            </td>
