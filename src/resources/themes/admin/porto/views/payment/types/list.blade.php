@extends('app', ['title' => 'Payment Method List'])
@section('content')
    <!-- start: page -->
    <div class="row">
        <div class="col">
...
{{--                                            <td>$200</td>--}}
                                            <td>
                                                <span class="ecommerce-status {{ $payment->status ? 'completed' : 'failed' }}">{{ $payment->status ? 'Active' : 'Passive' }}</span>
                                            </td>
                                            <td>{{ $payment->created_at }}</td>
                                            <td>
                                                <a href="{{ route('admin.payment.types.show', ['slug' => $payment]) }}" type="button" class="mb-1 mt-1 me-1 btn btn-primary"><i class="bx bx-pencil"></i></a>
