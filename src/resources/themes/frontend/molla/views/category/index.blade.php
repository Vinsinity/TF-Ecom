                            ...
                            <ul>
                                @foreach($categories as $category)
                                    <li><a href="#">{{ $category->name }} </a>
                                        <span>({{ count($category->products) }})</span></li>
                                @endforeach
                            </ul>
                        </div>
                                    ...
                                    @foreach($products as $product)
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                <div class="pro-img">
                                                    <img src="{{ asset(Storage::url('image/products/'.$product->images[0]->image)) }}"
                                                         alt="">
                                                </div>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a
                                                                href="{{ route('product.show', ['slug' => $product->slug]) }}">{{ $product->name }}</a>
                                                    </h5>
                                    ...
                                    <div class="col-xl-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 col-lg-6 col-xl-8">
                                                    <div class="list-pro-det">
                                                        ...
                                                        <p>Autem vel eum iriure dolor in hendrerit in vulputate velit
                                                            esse molestie consequat vel illdolore eu olestie consequat
                                                            feugiat nulla facilisis at vero eros.Autem vel eum iriure
                                        ...
                                        <div class="sin-product list-pro">
                                            <div class="row">
                                                <div class="col-md-5 col-lg-6 col-xl-4">
                                                    <div class="pro-img">
                                                        <img src="{{ asset('public') }}/media/images/product/lp2.jpg"
                                                             alt="">
                                                    </div>
                                        ...
                                        <div class="sin-product list-pro">
                                            <div class="row">
                                                <div class="col-md-5 col-lg-6 col-xl-4">
                                                    <div class="pro-img">
                                                        <img src="{{ asset('public') }}/media/images/product/lp3.jpg"
                                                             alt="">
                                                    </div>
                                                    <div class="pro-icon">
                                                        <ul>
