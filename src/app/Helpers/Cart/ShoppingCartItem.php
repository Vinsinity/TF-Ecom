...
class ShoppingCartItem implements Arrayable, Jsonable
{
    /**
     ...
     */
    public ShoppingCartItemOptions $options;
     ...
     * @param int|string $id
     */
    public function __construct($id, ?string $name, float $price, string $image, array $options = [])
    {
        if(empty($id)) {
        ...
        if(empty($image)) {
            throw new \InvalidArgumentException('Please supply a valid image.');
        }
        ...
        $this->price    = $price;
        $this->image    = $image;
        $this->options  = new ShoppingCartItemOptions($options);
    ...
    public function updateFromArray(array $attributes): void
    {
        ...
        $this->priceTax = $this->price + $this->tax;
        $this->options  = new ShoppingCartItemOptions(Arr::get($attributes, 'options', $this->options));
     ...
     */
    public static function fromBuyable(Buyable $item, array $options = []): ShoppingCartItem
    {
        return new self(
     ...
     */
    public static function fromArray(array $attributes): ShoppingCartItem
    {
     ...
     * @param int|string $id
     */
    public static function fromAttributes($id, string $image, ?string $name, float $price, array $options = []): ShoppingCartItem
    {
        return new self($id, $name, $price, $image, $options);
    }
